...
extern "C" {
#endif
extern void ovgTranslate(VGfloat, VGfloat);
extern void ovgRotate(VGfloat);
extern void ovgShear(VGfloat, VGfloat);
extern void ovgScale(VGfloat, VGfloat);
extern void ovgText(VGfloat, VGfloat, const char *, Fontinfo, int);
extern void ovgTextMid(VGfloat, VGfloat, const char *, Fontinfo, int);
extern void ovgTextEnd(VGfloat, VGfloat, const char *, Fontinfo, int);
extern VGfloat ovgTextWidth(const char *, Fontinfo, int);
extern void ovgCbezier(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgQbezier(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgPolygon(VGfloat *, VGfloat *, VGint);
extern void ovgPolyline(VGfloat *, VGfloat *, VGint);
extern void ovgRect(VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgLine(VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgRoundrect(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgEllipse(VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgCircle(VGfloat, VGfloat, VGfloat);
extern void ovgArc(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgImage(VGfloat, VGfloat, int, int, const char *);
extern void ovgStart(int, int);
extern void ovgEnd();
extern void ovgSaveEnd(const char *);
extern void ovgBackground(unsigned int, unsigned int, unsigned int);
extern void ovgBackgroundRGB(unsigned int, unsigned int, unsigned int, VGfloat);
extern void ovginit(int *, int *,DISPMANX_CALLBACK_FUNC_T cb_func);
extern void ovgfinish();
extern void ovgsetfill(VGfloat[4]);
extern void ovgsetstroke(VGfloat[4]);
extern void ovgStrokeWidth(VGfloat);
extern void ovgStroke(unsigned int, unsigned int, unsigned int, VGfloat);
extern void ovgFill(unsigned int, unsigned int, unsigned int, VGfloat);
extern void ovgRGBA(unsigned int, unsigned int, unsigned int, VGfloat, VGfloat[4]);
extern void ovgRGB(unsigned int, unsigned int, unsigned int, VGfloat[4]);
extern void ovgFillLinearGradient(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat *, int);
extern void ovgFillRadialGradient(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat *, int);
extern void ovgClipRect(VGint x, VGint y, VGint w, VGint h);
extern void ovgClipEnd();
extern Fontinfo ovgloadfont(const int *, const int *, const unsigned char *, const int *, const int *, const int *,
		const short *, int);
extern void ovgunloadfont(VGPath *, int);
extern void ovgmakeimage(VGfloat, VGfloat, int, int, VGubyte *);
extern void ovgsaveterm();
extern void ovgrestoreterm();
extern void ovgrawterm();

// Added by Paeryn
extern void ovgInitWindowSize(int x, int y, unsigned int w, unsigned int h);
extern VGfloat ovgTextHeight(Fontinfo f, int pointsize);
extern VGfloat ovgTextDepth(Fontinfo f, int pointsize);
extern void ovgAreaClear(unsigned int x, unsigned int y, unsigned int w, unsigned int h);
extern void ovgWindowClear();
extern void ovgWindowOpacity(unsigned int alpha);
extern void ovgWindowPosition(int x, int y);
extern void ovgCbezierOutline(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgQbezierOutline(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgRectOutline(VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgRoundrectOutline(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgEllipseOutline(VGfloat, VGfloat, VGfloat, VGfloat);
extern void ovgCircleOutline(VGfloat, VGfloat, VGfloat);
extern void ArcOutline(VGfloat, VGfloat, VGfloat, VGfloat, VGfloat, VGfloat);
extern VGImage ovgCreateImageFromJpeg(const char *);
#if defined(__cplusplus)
}
#endif
